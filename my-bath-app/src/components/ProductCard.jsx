...
const ProductCard = () => {
  ...
  return (
    <section className="py-20 bg-#778e9b w-full">
      <div className="container mx-auto px-6 w-full">
       <div className="text-center mb-16 bg-[#778e9b] py-10 rounded-xl text-white">
    ...
    of bathroom essentials designed to transform your space.
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {categories.map((category, index) => {
            ...
            return (
              <div key={category.name} className="card-premium group cursor-pointer relative overflow-hidden">
                ...
                <div className="relative z-10 p-6">
                  ...
                  <div className="space-y-4">
                    ...
                    <button 
                      className="w-full justify-between group-hover:bg-primary group-hover:text-primary-foreground transition-all duration-300 text-left px-4 py-2 bg-transparent border border-gray-300 rounded hover:border-primary"
                    >
                      Shop {category.name}
        ...
        <div className="mt-16 bg-[#778e9b] card rounded-2xl p-8 md:p-12 shadow-elegant">
