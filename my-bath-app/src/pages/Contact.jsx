  ...
  return (
    <div className="min-h-screen bg-[#e8ecef] text-[#607d9e] p-6">
      ...
      <div className="max-w-4xl mx-auto mt-12">
        ...
        <div className="w-full h-64 bg-[#f0f4f7] rounded-lg flex items-center justify-center shadow-sm">
          <span className="text-4xl font-bold text-[#b0b8c0]">Map Placeholder</span>
        </div>
      </div>
